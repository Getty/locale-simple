...
sub run {
    ...
    my @default = qw(--ignore blib --ignore \.build --ignore python --ignore js --ignore node_modules --ignore setup.py --ignore release-pod-syntax\.t --ignore author-pod-syntax\.t --ignore Locale-Simple-);
    my @groups  = (
